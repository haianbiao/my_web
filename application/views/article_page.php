             ...
             <?php
                  if(!empty($full_article))
                  {
	                                  ...
	                                  echo "<div  id = 'content_title'>";
	                                       echo  "<span style = 'font-size:30px'><a id = 'article_title' href='/my_web/index.php/article/show_article/".$full_article['id']."'> ".htmlspecialchars($full_article['title'])."</a></span>";
	                                  echo "</div>";
